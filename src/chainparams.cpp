...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("berycoin5.dynu.net", false); // Berycoin mainnet
        vSeeds.emplace_back("berycoin6.dynu.net", false); // Berycoin mainnet
        vSeeds.emplace_back("berycoin7.dynu.net", false); // Berycoin mainnet
