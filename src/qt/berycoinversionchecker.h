#ifndef BERYVERSIONCHECKER_H
#define BERYVERSIONCHECKER_H

#include <QObject>

#define BERY_RELEASES "https://github.com/berycoin-project/berycoin/releases"
